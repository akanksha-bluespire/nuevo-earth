...
const Cards = () => {
  return (
    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(287px, 0fr))', gap: '20px', justifyContent: 'center' }}>
      {data.map((item, index) => (
        // card heading
        <div key={index} style={{ border: '1px solid #ccc', padding: '10px', margin: '10px', width: '228px', height: '340px', backgroundColor: 'whitesmoke', color: 'black', boxShadow: '0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)' }}className="card">
