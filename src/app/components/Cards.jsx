...
const Cards = () => {
  return (
    <div style={{ display: 'grid', margin: '100px', gridTemplateColumns: 'repeat(auto-fill, minmax(287px, 0fr))', gap: '20px', justifyContent: 'center', alignItems: 'center', height: "auto", width: "auto", alignItems: 'center' }}>
      {data.map((item, index) => (
        // card heading
