...
const App: React.FC = () => {
  ...
  return (
        ...
        // <div className="flex flex-row flex-wrap bg-gray-200 justify-center items-center p-10 gap-16 h-full w-full">

    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 p-5 bg-gray-200 ">
